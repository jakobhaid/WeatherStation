...
Das Gehäuse für die Wetterstation kann über folgenden Link heruntergeladen werden: [Link zur 3D-Druck Datei](https://github.com/jkobh/WeatherStation/tree/wifi/3dmodels).
